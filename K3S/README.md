...
如果网络可以直接用脚本安装`curl -sfL https://get.k3s.io | sh -`

但是网络真的不行

```
$curl -o install.sh https://get.k3s.io  //下载脚本保存为install.sh
直接在github上慢慢下载：https://github.com/rancher/k3s/releases/download/v1.0.0/k3s
$sudo cp k3s /usr/local/bin
$sudo chmod +x /usr/local/bin/k3s
$cat install.sh | INSTALL_K3S_SKIP_DOWNLOAD=true sh -
```
